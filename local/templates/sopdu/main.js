$(document).ready(function () {
    ...
    function summCount() {
        ...
        $('.total-price-input').val(summ);
    }


    $('.table-img-link').fancybox();
...
$(document).ready(function () {
    ...
    $(".age-range").ionRangeSlider({
        ...
        onChange: function () {
            ...
            $('.age-val').html($('.age-range').val());
            $('.age-img').css('background-image', 'url("img/every-party/age/'+ img +'.jpg")');
        }
    })
    ...
    $(".flat-range").ionRangeSlider({
        ...
        onChange: function () {
            ...
            $('.flat-img').css('background-image', 'url("img/every-party/flat/'+ img +'.jpg")');
    ...
    $(".level-range").ionRangeSlider({
        ...
        onChange: function () {
            ...
            $('.level-img').css('background-image', 'url("img/every-party/level/'+ img +'.jpg")');
    ...
    $(".players-range").ionRangeSlider({
        ...
        onChange: function () {
            ...
            $('.players-img').css('background-image', 'url("img/every-party/players/'+ img +'.jpg")');
